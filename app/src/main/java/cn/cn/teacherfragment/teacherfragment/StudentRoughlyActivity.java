...
public class StudentRoughlyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fragment_student_roughly);
        init();
    }

    private void init(){
        textView = (TextView)findViewById(R.id.activity_fragment_student_roughly_textview);
        listView = (ListView)findViewById(R.id.activity_fragment_student_roughly_listview);
        getUserID();
        setAdapter();
    }
    ...
    private void setAdapter(){
        getList();
        TopicClassAdapter adapter = new TopicClassAdapter(this,list,"R",goTo);
