...
public class AnswerStudentTopicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_answer_student_topic);
        init();
    }

    private void init(){
        textView = (TextView)findViewById(R.id.activity_answer_student_topic_textview);
        listView = (ListView)findViewById(R.id.activity_answer_student_topic_listview);
        setAdapter();
    }
    ...
    private void getList(){
        ...
        cursor_topicClass = queryDB.queryTopicClassBySorTSon("学生",sID);
        if(!cursor_topicClass.moveToFirst()){
            textView.setText("还没有学生分享题哟~");
            return;
        }
        ...
        while (cursor_topicClass.moveToNext()){
            ...
            bean = new TopicClassBean(topicClassName,String.valueOf(n)+"            发布学生："+tName
